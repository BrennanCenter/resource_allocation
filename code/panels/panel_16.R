...
wait <- readRDS("./temp/waits_2016.rds") %>% 
  filter(race == "Black")
...
income_lu <- data.frame("family_income" = c("Less than $10,000", "$10,000 - $19,999",
                        ...
                        "income" = c(5000, 15000, 25000, 35000, 45000, 55000, 65000, 75000, 90000, 110000,
                                     135000, 150000, 150000, 150000, 150000, 150000, 150000, 150000))
...
save(genout, file = "./temp/w16_genout.rdata")
...
saveRDS(matches, "./temp/balanced_16.rds")